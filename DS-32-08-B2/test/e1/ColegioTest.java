...
class ColegioTest {
    String resultadoImprimirRecompensas =
                    ...
                    "Pepa Pig(Guardabosques ,5 horrocruxes): 415.0 galeones" +
                    ...
                    "Pepito Grillo(Docente de Herbologia ,3 horrocruxes): 750.0 galeones" +
                    "Paco Garcia(Docente de Defensa ,2 horrocruxes): 75.0 galeones" +
                    "La recompensa total del Colegio Hogwarts es de 1625.0 galeones";
    ...
    public void imprimirRecompensas() {
        ...
        Integrantes i1 = new Conserjes("Critobal", "Colon", 18, 1, 2); //Correcto
        ...
        Integrantes i6 = new Docentes("Pepito", "Grillo2", 2, Docentes.Asignaturas.Herbologia,3); //Exception, no puede haber dos docentes para la misma asignatura
        Integrantes i7 = new Docentes("Paco", "Garcia", 2, Docentes.Asignaturas.Defensa,2); //Correcto
